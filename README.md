...
<img width="1000" height="200" alt="Screenshot 2025-11-29 160907" src="https://github.com/user-attachments/assets/445db1aa-ba48-4b34-a0b5-e5158251d9f4" />
...
이 프로젝트는 **네트워크 동기화·실시간 입출력·알고리즘 최적화**를 고려해 설계
...
사용자 입력과 네트워크 통신을 **Polling 방식**으로 처리.
